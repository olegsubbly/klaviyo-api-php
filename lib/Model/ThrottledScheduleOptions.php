...
/**
 * ThrottledScheduleOptions Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class ThrottledScheduleOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThrottledScheduleOptions';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('throttle_percentage', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int $throttle_percentage The percentage of recipients per hour to send to. Allowed values: [10, 11, 13, 14, 17, 20, 25, 33, 50]
     *
     * @return self
     */
    public function setThrottlePercentage($throttle_percentage)
    {
        ...
        if (is_null($throttle_percentage)) {
            throw new \InvalidArgumentException('non-nullable throttle_percentage cannot be null');
        }
