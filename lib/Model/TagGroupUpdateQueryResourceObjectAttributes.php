...
/**
 * TagGroupUpdateQueryResourceObjectAttributes Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class TagGroupUpdateQueryResourceObjectAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TagGroupUpdateQueryResourceObject_attributes';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The Tag Group name
     *
     * @return self
     */
     ...
     * Sets return_fields
     *
     * @param string[]|null $return_fields return_fields
     *
     * @return self
     */
