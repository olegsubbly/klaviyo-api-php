...
/**
 * TemplateCreateQueryResourceObjectAttributes Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class TemplateCreateQueryResourceObjectAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateCreateQueryResourceObject_attributes';
    ...
    */
     ...
     * Sets html
     *
     * @param string|null $html The HTML contents of the template
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text The plaintext version of the template
     *
     * @return self
     */
