...
/**
 * CampaignCloneQueryResourceObjectAttributes Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class CampaignCloneQueryResourceObjectAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignCloneQueryResourceObject_attributes';
    ...
    */
     ...
     * Sets new_name
     *
     * @param string|null $new_name The name for the new cloned campaign
     *
     * @return self
     */
